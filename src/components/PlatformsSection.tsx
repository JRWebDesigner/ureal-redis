...
export default function PlatformsSection() {
  return (
    ...
    <section className="relative bg-[url('/Images/appFondo.jpg')] bg-cover h-[120dvh] md:h-[80dvh] max-h-[600px] w-full grid md:grid-cols-2 place-items-center px-22 py-16 gap-8">
