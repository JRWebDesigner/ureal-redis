...
export default function PlatformsSection() {
  return (
    ...
    <section className="relative bg-[url('/Images/appFondo.jpg')] bg-cover min-h-[100dvh] h-auto md:h-[70dvh] w-full grid md:grid-cols-2 place-items-center px-22 py-16 gap-8">
